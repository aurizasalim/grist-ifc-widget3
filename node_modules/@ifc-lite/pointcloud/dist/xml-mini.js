...
export function parseXml(xml) {
    const root = { name: '', attrs: new Map(), children: [], text: '' };
    const stack = [root];
    let i = 0;
    const n = xml.length;
    let textStart = -1;
...
// ─── tree helpers ───────────────────────────────────────────────────────────
export function childByName(parent, name) {
...
export function childrenByName(parent, name) {
    return parent.children.filter((c) => c.name === name);
}
export function textChild(parent, name) {
...
//# sourceMappingURL=xml-mini.js.map