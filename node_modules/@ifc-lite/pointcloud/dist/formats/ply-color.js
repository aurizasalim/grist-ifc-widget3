...
export function floatColorSelectsByteRange(value, type) {
 ...
 */
export function normalizeColorChannel(value, type, floatUsesByteRange = false) {
 ...
 */
export function normalizePlyColors(colors, types) {
...
//# sourceMappingURL=ply-color.js.map