 ...
 */
export function lasClassificationName(classId) {
    if (!Number.isInteger(classId) || classId < 0 || classId >= LAS_CLASS_COUNT)
        return 'Unknown';
    if (classId < ASPRS_STANDARD_NAMES.length)
        return ASPRS_STANDARD_NAMES[classId];
    if (classId < 64)
        return 'Reserved';
    return 'User defined';
}
 ...
 */
export function accumulateClassificationCounts(counts, chunk) {
