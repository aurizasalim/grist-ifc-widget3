 ...
 */
import type { IfcActorRole, IfcAddress, IfcAppliedValue, IfcApproval, IfcAxis2Placement2D, IfcAxis2Placement3D, IfcBooleanResult, IfcBoundedCurve, IfcCartesianPoint, IfcClassification, IfcClassificationReference, IfcClosedShell, IfcColourRgb, IfcColourSpecification, IfcCompositeCurveOnSurface, IfcConstraint, IfcContextDependentUnit, IfcConversionBasedUnit, IfcCoordinateReferenceSystem, IfcCsgPrimitive3D, IfcCurve, IfcCurveStyle, IfcCurveStyleFont, IfcCurveStyleFontAndScaling, IfcDerivedUnit, IfcDirection, IfcDocumentInformation, IfcDocumentReference, IfcEdgeCurve, IfcElement, IfcExternalInformation, IfcExternalReference, IfcExternalSpatialElement, IfcExternallyDefinedHatchStyle, IfcExternallyDefinedSurfaceStyle, IfcExternallyDefinedTextFont, IfcFaceBasedSurfaceModel, IfcFaceSurface, IfcFillAreaStyle, IfcFillAreaStyleHatching, IfcFillAreaStyleTiles, IfcGeometricRepresentationContext, IfcHalfSpaceSolid, IfcLibraryInformation, IfcLibraryReference, IfcLightIntensityDistribution, IfcMaterialDefinition, IfcMaterialList, IfcMaterialUsageDefinition, IfcMeasureWithUnit, IfcMonetaryUnit, IfcNamedUnit, IfcObjectDefinition, IfcOpenShell, IfcOrganization, IfcPcurve, IfcPerson, IfcPersonAndOrganization, IfcPhysicalQuantity, IfcPoint, IfcPreDefinedColour, IfcPreDefinedCurveFont, IfcPreDefinedTextFont, IfcPresentationStyle, IfcPresentationStyleAssignment, IfcProcess, IfcProduct, IfcProductDefinitionShape, IfcProfileDef, IfcPropertyAbstraction, IfcPropertyDefinition, IfcPropertySetDefinition, IfcReference, IfcRepresentation, IfcRepresentationItem, IfcRepresentationMap, IfcResource, IfcSolidModel, IfcSpace, IfcStructuralItem, IfcSurface, IfcSurfaceCurve, IfcSurfaceStyle, IfcSurfaceStyleLighting, IfcSurfaceStyleRefraction, IfcSurfaceStyleShading, IfcSurfaceStyleWithTextures, IfcTable, IfcTessellatedFaceSet, IfcTextStyle, IfcTimeSeries, IfcTypeProcess, IfcTypeProduct, IfcTypeResource, IfcVector, IfcVertexPoint, IfcVirtualGridIntersection } from './entities.js';
import type { IfcArcIndex, IfcBinary, IfcBoolean, IfcComplexNumber, IfcDate, IfcDateTime, IfcDuration, IfcIdentifier, IfcInteger, IfcLabel, IfcLineIndex, IfcLogical, IfcParameterValue, IfcPositiveInteger, IfcPropertySetDefinitionSet, IfcReal, IfcSpecularExponent, IfcSpecularRoughness, IfcText, IfcTime, IfcTimeStamp } from './types.js';
import type { IfcNullStyle } from './enums.js';
/** IfcActorSelect */
