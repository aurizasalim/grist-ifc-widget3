...
import { generateStepFileWithRegistry, toStepLineWithRegistry, } from '@ifc-lite/data';
export { isEntityRef, isEnumValue, ref, enumVal, serializeValue, generateHeader, parseStepValue, } from '@ifc-lite/data';
/**
 * Serialize an entity to a STEP line (bound to this bundle's schema).
 */
export function toStepLine(entity) {
    return toStepLineWithRegistry(SCHEMA_REGISTRY, entity);
}
/**
 * Generate complete STEP file content (bound to this bundle's schema).
 */
export function generateStepFile(entities, options) {
