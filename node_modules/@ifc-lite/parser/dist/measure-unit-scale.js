 ...
 */
export function scaleMeasureValue(value, dataType, projectUnits) {
    if (typeof value !== 'number' || !dataType)
        return value;
 ...
 */
export function roundToScale(value) {
