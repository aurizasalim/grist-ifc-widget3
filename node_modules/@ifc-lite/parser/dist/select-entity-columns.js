 ...
 */
export async function selectEntityColumns(columns, count, includeType, rows, chunkSize = 8192, budgetMs = 50) {
    ...
    for (let at = 0; at < inputCount; at++) {
        ...
        if (includedTypes && !includedTypes[sourceType])
            continue;
...
//# sourceMappingURL=select-entity-columns.js.map