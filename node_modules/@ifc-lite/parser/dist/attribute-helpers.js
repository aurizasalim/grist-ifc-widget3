 ...
 */
export function isOverflowingNumericLiteral(raw) {
 ...
 */
export function isUnrepresentableNumericValue(raw) {
...
export function getReference(value) {
    ...
    if (typeof value === 'number')
        return isIndexableExpressId(value) ? value : undefined;
    if (typeof value === 'string' && value.startsWith('#')) {
        const num = parseInt(value.substring(1));
        if (isIndexableExpressId(num))
            return num;
    }
    return undefined;
}
export function getReferences(value) {
