...
function siUnitName(name) {
    const n = name.replace(/\./g, '').trim().toUpperCase();
    const d = (symbol) => ({ symbol, prefixPower: 1, baseScale: 1.0 });
    switch (n) {
...
export function conversionUnitSymbol(name) {
