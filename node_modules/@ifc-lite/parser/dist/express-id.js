 ...
 * 4294967295.
 */
export function isIndexableExpressId(id) {
 ...
 */
export function checkedExpressId(id) {
    if (!isIndexableExpressId(id)) {
        throw new RangeError(`express id ${id} cannot be stored: ids must be integers in [0, ${MAX_EXPRESS_ID}] (#3395)`);
    }
    return id;
}
//# sourceMappingURL=express-id.js.map