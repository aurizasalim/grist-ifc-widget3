...
// too.
export const ENTITY_NAME_ALIASES = {
 ...
 */
export function resolveEntityNameAlias(type) {
...
const NON_ENTITY_NAMES_UPPER = new Set([
 ...
 */
function getEntityInfoAcrossSchemas(type) {
    const upper = type.toUpperCase();
    if (NON_ENTITY_NAMES_UPPER.has(upper))
        return undefined;
    return ENTITY_INFO_BY_UPPER.get(upper);
}
function getInheritanceChainFromSchemaUnion(type) {
    const upper = type.toUpperCase();
 ...
 */
export function getAttributeNamesAcrossSchemas(type) {
...
export function isKnownType(type) {
    if (getEntityInfoAcrossSchemas(type))
        return true;
 ...
 */
export function isInstantiable(type) {
...
export function getInheritanceChain(type) {
    ...
    if (fromUnion && fromUnion.length > 0)
        return fromUnion;
 ...
 */
export function normalizeIfcTypeName(type) {
 ...
 */
export function isQueryableObjectType(type) {
