...
export function compactEntityIndexToColumns(index) {
    return index.getColumns();
}
export function compactEntityIndexFromColumns(columns) {
    return new CompactEntityIndex(columns.expressIds, columns.byteOffsets, columns.byteLengths, columns.typeIndices, columns.typeStrings);
}
//# sourceMappingURL=compact-entity-index-transport.js.map