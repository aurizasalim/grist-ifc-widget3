...
import { internType } from './compact-entity-index-columns.js';
...
export class CompactEntityIndexBuilder {
    ...
    byteLengths;
    typeIndices;
    typeStringMap = new Map();
    typeStrings = [];
    count = 0;
    capacity;
    constructor(estimatedCount) {
    ...
    add(expressId, type, byteOffset, byteLength) {
    ...
    build(lruMaxSize) {
        ...
        return new CompactEntityIndex(this.expressIds.slice(0, n), this.byteOffsets.slice(0, n), this.byteLengths.slice(0, n), this.typeIndices.slice(0, n), this.typeStrings, lruMaxSize);
    }
}
/**
...
export async function buildCompactEntityIndexAsync(entityRefs, lruMaxSize, chunkSize = 8192, 
