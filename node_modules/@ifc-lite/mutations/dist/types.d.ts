 ...
 */
export type IfcAttributeValue = string | number | boolean | null | {
    real: number;
} | {
    typed: {
        type: string;
 ...
 */
export type MutationType = 'CREATE_PROPERTY' | 'UPDATE_PROPERTY' | 'DELETE_PROPERTY' | 'CREATE_PROPERTY_SET' | 'DELETE_PROPERTY_SET' | 'CREATE_QUANTITY' | 'UPDATE_QUANTITY' | 'DELETE_QUANTITY'
 ...
 *  floor, and both replay consumers key off `propName` being present. */
 | 'DELETE_QUANTITY_SET' | 'UPDATE_ATTRIBUTE' | 'UPDATE_POSITIONAL_ATTRIBUTE' | 'UPDATE_ENTITY_TYPE' | 'CREATE_ENTITY' | 'DELETE_ENTITY';
/**
 ...
 */
export type EffectiveChangeKind = 'attribute' | 'property' | 'quantity' | 'pset-added' | 'pset-deleted' | 'qset-added' | 'qset-deleted' | 'type' | 'entity-added' | 'entity-deleted';
/**
