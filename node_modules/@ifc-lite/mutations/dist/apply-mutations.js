 ...
 */
export function applyMutationsBatch(target, mutations, hasNewEntity, markQuantitySetDeleted, ensureQuantityDeletion) {
        ...
        switch (mutation.type) {
            ...
            case 'UPDATE_PROPERTY':
                if (mutation.psetName && mutation.propName && mutation.newValue !== undefined) {
                    target.setProperty(mutation.entityId, mutation.psetName, mutation.propName, mutation.newValue, mutation.valueType);
                }
                break;
            ...
            case 'DELETE_QUANTITY':
                if (mutation.psetName && mutation.propName) {
                    ...
                    ensureQuantityDeletion(mutation, mutation.psetName, mutation.propName, applied === null);
                }
                break;
            case 'CREATE_QUANTITY':
            case 'UPDATE_QUANTITY':
                if (mutation.psetName && mutation.propName && mutation.newValue !== undefined) {
                    target.setQuantity(mutation.entityId, mutation.psetName, mutation.propName, Number(mutation.newValue), mutation.quantityType ?? QuantityType.Count, mutation.unit);
                }
                    ...
                    target.createQuantitySet(mutation.entityId, mutation.psetName, mutation.newValue);
                }
                break;
            case 'UPDATE_POSITIONAL_ATTRIBUTE': {
                ...
                if (mutation.newValue === undefined)
                    break;
                target.setPositionalAttribute(mutation.entityId, index, mutation.newValue);
                break;
            }
            case 'UPDATE_ENTITY_TYPE': {
                ...
                if (!newType)
                    break;
                target.setEntityType(mutation.entityId, newType, mutation.predefinedType ?? null, mutation.oldValue == null ? undefined : String(mutation.oldValue));
                break;
            }
            case 'UPDATE_ATTRIBUTE':
                if (mutation.attributeName && mutation.newValue !== undefined && mutation.newValue !== null) {
                    target.setAttribute(mutation.entityId, mutation.attributeName, String(mutation.newValue), mutation.oldValue == null ? undefined : String(mutation.oldValue));
                }
                break;
            case 'CREATE_PROPERTY_SET':
                if (mutation.psetName && Array.isArray(mutation.newValue)) {
                    ...
                    target.createPropertySet(mutation.entityId, mutation.psetName, mutation.newValue);
                }
                break;
            case 'CREATE_ENTITY': {
...
//# sourceMappingURL=apply-mutations.js.map