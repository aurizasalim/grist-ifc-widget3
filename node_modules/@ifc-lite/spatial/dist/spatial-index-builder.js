 ...
 */
export function buildSpatialIndex(meshes) {
    const meshesWithBounds = meshes.map(mesh => {
 ...
 */
export async function buildSpatialIndexAsync(meshes, budgetMs = 4) {
    const meshesWithBounds = new Array(meshes.length);
...
//# sourceMappingURL=spatial-index-builder.js.map