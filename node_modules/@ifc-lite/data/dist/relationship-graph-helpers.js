 ...
 */
export function edgeSurvives(edge, isDeleted) {
    if (!isDeleted(edge.relationshipId))
        return true;
 ...
 */
export function flattenRelationshipEdges(edges) {
    const out = [];
 ...
 */
export function buildShadowedColumns(pairs) {
...
export function binarySearchU32(arr, target) {
    let lo = 0;
    let hi = arr.length - 1;
    while (lo <= hi) {
        const mid = (lo + hi) >>> 1;
...
//# sourceMappingURL=relationship-graph-helpers.js.map