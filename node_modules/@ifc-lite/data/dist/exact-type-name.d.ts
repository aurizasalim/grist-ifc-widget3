...
export type ExactTypeNameSource = Pick<EntityTable, 'getTypeName'> & Partial<Pick<EntityTable, 'getExactTypeName'>>;
/**
 ...
 * module.
 */
export declare function exactNameOfRow(strings: StringTable, rawTypeName: Uint32Array, typeEnum: Uint16Array, rowIndex: number): string;
/**
 ...
 */
export declare function exactTypeName(entities: ExactTypeNameSource, expressId: number): string;
//# sourceMappingURL=exact-type-name.d.ts.map