...
export function planeBasis(normal) {
    ...
    if (!(nlen > 0 && nlen < Infinity))
        return degenerateBasis();
 ...
 */
export function nearestCardinalAxis(normal) {
...
//# sourceMappingURL=section-plane-basis.js.map