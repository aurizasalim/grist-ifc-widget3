 ...
 */
export function parseBoxAlignment(s) {
    ...
    let vertical;
    if (verticalToken.includes('top'))
        vertical = 0;
    else if (verticalToken.includes('middle') || verticalToken.includes('center'))
        vertical = -0.5;
    else
        vertical = -1;
    let horizontal;
    if (horizontalToken.includes('right'))
        horizontal = -1;
    else if (horizontalToken.includes('middle') || horizontalToken.includes('center'))
        horizontal = -0.5;
    else
        horizontal = 0;
