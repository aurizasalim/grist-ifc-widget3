 ...
 */
export const LINE_OVERLAY_CHANNELS = ['annotation', 'alignment', 'grid', 'dxf'];
export class Section2DOverlayRenderer {
     ...
     */
    drawLineOverlay(pass, viewProj, channel) {
        this.init();
