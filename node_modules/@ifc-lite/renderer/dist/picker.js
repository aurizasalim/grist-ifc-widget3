 ...
 */
function releaseReadbacks(...buffers) {
...
export class Picker {
    ...
    webgpuDevice;
    pipeline;
    instancedPickPipeline = null; // GPU-instancing: pick pass for instanced occurrences; null if the backend rejected it
    instancedPickBindGroup = null;
    depthTexture;
    colorTexture;
    uniformBuffer;
    expressIdBuffer;
    ...
    uniformScratch = new Float32Array(32);
    clipFlags = new Uint32Array(this.uniformScratch.buffer, 112, 4);
     ...
     */
    async pick(x, y, width, height, meshes, viewProj, pointNodes, pointSizing, instancedTemplates, clip) {
        if (this.destroyed)
            return null;
     ...
     */
    writePickUniforms(viewProj, clip) {
     ...
     */
    async pickRect(x0, y0, x1, y1, width, height, meshes, viewProj, pointNodes, pointSizing, instancedTemplates, clip) {
        if (this.destroyed)
            return new Set();
     ...
     */
    renderPickPass(width, height, meshes, viewProj, pointNodes, pointSizing, instancedTemplates, clip) {
