 ...
 */
export function colorSaltByte(color) {
    if (!color)
        return 0;
...
export function packEntityLane(rawId, saltByte) {
 ...
 */
export function destroyGpuResources(m) {
...
export function cachedWorldAabb(id, pieces, cache) {
