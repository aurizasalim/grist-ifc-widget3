 ...
 */
function bridgeIsClear(boundary, hole, anchorIdx, startIdx) {
    ...
    for (let i = 0; i < boundary.length; i++) {
        ...
        if (i !== anchorIdx && pointOnSegment(boundary[i], a, b, false))
            return false;
    }
    for (let i = 0; i < hole.length; i++) {
        ...
        if (i !== startIdx && pointOnSegment(hole[i], a, b, false))
            return false;
    }
    return true;
}
 ...
 */
export function chooseBridgeAnchor(boundary, hole, startIdx) {
    ...
    for (const candidate of ranked) {
        if (bridgeIsClear(boundary, hole, candidate.i, startIdx))
            return candidate.i;
    }
    return ranked[0].i;
}
//# sourceMappingURL=fill-bridge-anchor.js.map