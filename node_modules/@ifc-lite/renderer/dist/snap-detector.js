...
import { bestEdgeCandidate, detectCorner } from './snap-corner.js';
export var SnapType;
(function (SnapType) {
    ...
    SnapType["POINT_CLOUD"] = "point_cloud";
})(SnapType || (SnapType = {}));
...
export class SnapDetector {
     ...
     */
    detectSnapTarget(ray, meshes, intersection, camera, screenHeight, options = {}, accept) {
    ...
    detectMagneticSnap(ray, meshes, intersection, camera, screenHeight, currentEdgeLock, options = {}) {
        ...
        const bestEdge = bestEdgeCandidate(nearbyEdges);
        // Check if we're at a corner (near a run endpoint or an interior junction)
        const cornerInfo = detectCorner(bestEdge.edge, bestEdge.t, cornerRadius, intersection.point);
    ...
    maintainEdgeLock(point, currentLock, cache, worldSnapRadius, meshExpressId) {
        ...
        const matchingEdge = cache.edges.find(e => (vecEquals(e.v0, v0) && vecEquals(e.v1, v1)) ||
        ...
        const edgeForCorner = matchingEdge
            ? (flipped
                ? {
                    ...matchingEdge,
                    v0: matchingEdge.v1,
     ...
     */
    cacheKeyFor(mesh) {
        if (mesh.occurrenceKey !== undefined)
            return mesh.occurrenceKey;
