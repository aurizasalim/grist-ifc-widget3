...
export class BVH {
    ...
    buildNode(meshIndices) {
        ...
        const sortedIndices = [...meshIndices].sort((a, b) => this.cachedCenter(a, k) - this.cachedCenter(b, k));
