...
export class PointCloudSpatialIndex {
    ...
    constructor(cellSize = DEFAULT_POINTCLOUD_INDEX_CELL_SIZE, maxIndexedPoints = DEFAULT_MAX_INDEXED_POINTS, maxIndexedCells = DEFAULT_MAX_INDEXED_CELLS) {
        ...
        const requestedCells = maxIndexedCells > 0 && Number.isFinite(maxIndexedCells)
    ...
    reportCapIfBound() {
        ...
        if (!reason)
            return;
        console.warn(`[PointCloudSpatialIndex] measure-snap index closed at its ${reason} limit ` +
