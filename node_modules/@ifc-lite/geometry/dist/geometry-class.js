 ...
 */
export function geometryClassOf(mesh) {
 ...
 */
export function isPlacedGeometryClass(geometryClass) {
...
export function isTypeLibraryGeometryClass(geometryClass) {
    return geometryClass === GEOM_CLASS_ORPHAN_TYPE || geometryClass === GEOM_CLASS_INSTANCED_TYPE;
}
//# sourceMappingURL=geometry-class.js.map