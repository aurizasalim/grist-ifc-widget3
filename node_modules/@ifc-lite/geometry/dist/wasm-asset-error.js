 ...
 */
export function isWasmAssetUnavailableError(err) {
 ...
 */
export function isWorkerScriptSkewMessage(err) {
 ...
 */
export function notifyIfWasmAssetUnavailable(err) {
 ...
 */
export function notifyIfWorkerScriptUnavailable(err, receivedAnyMessage) {
...
//# sourceMappingURL=wasm-asset-error.js.map