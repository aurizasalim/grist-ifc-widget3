...
export function isInstancedShard(payload) {
    try {
 ...
 * truncated buffer.
 */
export function decodeInstancedShard(payload) {
    const buffer = toArrayBuffer(payload);
...
//# sourceMappingURL=packed-instanced-decoder.js.map