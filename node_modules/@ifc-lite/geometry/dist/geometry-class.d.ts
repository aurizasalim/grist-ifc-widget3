...
export declare const GEOM_CLASS_OCCURRENCE = 0;
/** Type-library geometry with no occurrence placing it. */
export declare const GEOM_CLASS_ORPHAN_TYPE = 1;
/** Type geometry drawn as an instanced duplicate of a placed occurrence. */
export declare const GEOM_CLASS_INSTANCED_TYPE = 2;
/**
 ...
 */
export declare const GEOM_CLASS_LAYER_SLICE = 3;
/**
 ...
 */
export declare function geometryClassOf(mesh: {
 ...
 */
export declare function isPlacedGeometryClass(geometryClass: number): boolean;
/** Is this class type-library geometry rather than model geometry? */
export declare function isTypeLibraryGeometryClass(geometryClass: number): boolean;
//# sourceMappingURL=geometry-class.d.ts.map