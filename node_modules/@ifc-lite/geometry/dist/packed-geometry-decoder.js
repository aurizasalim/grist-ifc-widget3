...
export function decodePackedGeometryCacheShard(payload, jsReceivedTimeMs, batchSequence) {
    ...
    for (let meshIndex = 0; meshIndex < meshCount; meshIndex += 1) {
        ...
        if (positionsOffsetWords + positionsLengthWords > positionsLen ||
