 ...
 */
export declare const DEFAULT_BATCH_SIZING: BatchSizingConfig;
/**
 ...
 */
export declare function resolveBatchSizing(partial?: Partial<BatchSizingConfig> | null): BatchSizingConfig;
/**
 ...
 */
export declare function nextAdaptiveBatchJobs(current: number, jobs: number, elapsedMs: number, cfg?: BatchSizingConfig): number;
//# sourceMappingURL=batch-sizing.d.ts.map